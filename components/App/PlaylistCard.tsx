...
import UsersProfilePhotos from "./LikeProfilePhotos";

const PlaylistCard = () => {
  return (
    <div id={styles.PLAYLIST_CARD_CTN}>
      <div className={styles["playlist-title"]}>Currated Playlist</div>
      <div className={styles.mid}>
        <div className={styles["playlist-type"]}>R & B Hits</div>
