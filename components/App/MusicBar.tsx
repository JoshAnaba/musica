    ...
    <div id={styles.MUSICBAR_CONTAINER}>
      <div className={styles.lhs}>
        ...
        <div className={styles["music-content"]}>
          <p className={styles.title}>Seasons in</p>
          <p className={styles.artiste}>James</p>
        </div>
      </div>
...
// TODO: axios configuration, data calls script
// TODO: music player functionality: link https://codesandbox.io/s/5wwj02qy7k?file=/src/Bar.js
